...
(globalThis.webpackChunkStaticCmsApp = globalThis.webpackChunkStaticCmsApp || []).push([
  ...
  {
    32355: (O, $, e) => {
      (e.r($), e.d($, { sass: () => W, sassCompletionSource: () => x, sassLanguage: () => v }));
      var a = e(64963),
        Q = e(7778);
      const i = [
      ...
      function S(O) {
        let $;
        return O.next == n && (($ = O.peek(1)) == n || $ == t);
      }
      const r = new a.Jq(
          (O, $) => {
            if ($.dialectEnabled(0)) {
              let e;
              if (O.next < 0 && $.canShift(155)) O.acceptToken(155);
              else if (((e = O.peek(-1)) == R || e < 0) && $.canShift(154)) {
                let $ = 0;
                for (; O.next != R && i.includes(O.next);) (O.advance(), $++);
                O.next == R || S(O) ? O.acceptToken(154, -$) : $ && O.acceptToken(156);
              } else if (O.next == R) O.acceptToken(153, 1);
              ...
              let $ = 0;
              for (; i.includes(O.next);) (O.advance(), $++);
              $ && O.acceptToken(156);
            }
          },
          { contextual: !0 },
              ...
              if ($ > -1) {
                ...
                for (O.advance(); O.next >= 0;)
                  if (O.next == R) {
                    O.advance();
                    let e = 0;
                    for (; O.next != R && i.includes(O.next);) (e++, O.advance());
                    if (e < $) {
                      a = -e - 1;
                      break;
                    }
                  } else {
                    if (e && O.next == t && O.peek(1) == n) {
                      a = 2;
                      break;
                    }
                    O.advance();
                  }
                return void O.acceptToken(e ? 7 : 6, a);
              }
            }
            if (O.next == n) {
        ...
        c = new a.Jq((O, $) => {
          (43 != O.next && 61 != O.next) ||
            !$.dialectEnabled(0) ||
            O.acceptToken(61 == O.next ? 8 : 9, 1);
        }),
        P = new a.Jq((O, $) => {
          if (!$.dialectEnabled(0)) return;
          let e = $.context.depth;
          if (O.next < 0 && e) O.acceptToken(149);
          else if (O.peek(-1) == R) {
            let $ = 0;
            for (; O.next != R && i.includes(O.next);) (O.advance(), $++);
            $ == e || O.next == R || S(O) || ($ < e ? O.acceptToken(149, -$) : O.acceptToken(148));
          }
        }),
        X = new a.Jq((O, $) => {
          for (let e = !1, a = 0, Q = 0; ; Q++) {
            let { next: i } = O;
            if (!(o(i) || 45 == i || 95 == i || (e && l(i)))) {
              if (35 == i && 123 == O.peek(1)) {
                O.acceptToken(5, 2);
                break;
              }
              e && O.acceptToken(40 == i ? 151 : 2 == a && $.canShift(4) ? 4 : 152);
              break;
            }
            (!e && (45 != i || Q > 0) && (e = !0), a === Q && 45 == i && a++, O.advance());
          }
        }),
        f = new a.Jq((O) => {
          if (125 == O.next) {
            for (O.advance(); o(O.next) || 45 == O.next || 95 == O.next || l(O.next);) O.advance();
            35 == O.next && 123 == O.peek(1) ? O.acceptToken(2, 2) : O.acceptToken(1);
          }
        }),
        m = new a.Jq((O) => {
          if (i.includes(O.peek(-1))) {
            let { next: $ } = O;
            (o($) || 95 == $ || 35 == $ || 46 == $ || 91 == $ || 58 == $ || 45 == $ || 38 == $) &&
              O.acceptToken(150);
          }
        }),
        p = new a.Jq((O) => {
          if (!i.includes(O.peek(-1))) {
            let { next: $ } = O;
            if ((37 == $ && (O.advance(), O.acceptToken(3)), o($))) {
              do {
                O.advance();
              } while (o(O.next));
              O.acceptToken(3);
      ...
      function y(O, $) {
        ((this.parent = O),
          (this.depth = $),
          (this.hash = (O ? (O.hash + O.hash) << 8 : 0) + $ + ($ << 4)));
      }
      const s = new y(null, 0),
        T = new a.IK({
          start: s,
          shift: (O, $, e, a) => (148 == $ ? new y(O, e.pos - a.pos) : 149 == $ ? O.parent : O),
          hash: (O) => O.hash,
        }),
        Z = (0, Q.Gv)({
          "AtKeyword import charset namespace keyframes media supports include mixin use forward extend at-root":
            Q.pJ.definitionKeyword,
          "Keyword selector": Q.pJ.keyword,
          ControlKeyword: Q.pJ.controlKeyword,
          NamespaceName: Q.pJ.namespace,
          KeyframeName: Q.pJ.labelName,
          TagName: Q.pJ.tagName,
          "ClassName Suffix": Q.pJ.className,
          PseudoClassName: Q.pJ.constant(Q.pJ.className),
          IdName: Q.pJ.labelName,
          "FeatureName PropertyName": Q.pJ.propertyName,
          AttributeName: Q.pJ.attributeName,
          NumberLiteral: Q.pJ.number,
          KeywordQuery: Q.pJ.keyword,
          UnaryQueryOp: Q.pJ.operatorKeyword,
          "CallTag ValueName": Q.pJ.atom,
          VariableName: Q.pJ.variableName,
          SassVariableName: Q.pJ.special(Q.pJ.variableName),
          Callee: Q.pJ.operatorKeyword,
          Unit: Q.pJ.unit,
          "UniversalSelector NestingSelector IndentedMixin IndentedInclude":
            Q.pJ.definitionOperator,
          MatchOp: Q.pJ.compareOperator,
          "ChildOp SiblingOp, LogicOp": Q.pJ.logicOperator,
          BinOp: Q.pJ.arithmeticOperator,
          "Important Global Default": Q.pJ.modifier,
          Comment: Q.pJ.blockComment,
          LineComment: Q.pJ.lineComment,
          ColorLiteral: Q.pJ.color,
          "ParenthesizedContent StringLiteral": Q.pJ.string,
          "InterpolationStart InterpolationContinue InterpolationEnd": Q.pJ.meta,
          ': "..."': Q.pJ.punctuation,
          "PseudoOp #": Q.pJ.derefOperator,
          "; ,": Q.pJ.separator,
          "( )": Q.pJ.paren,
          "[ ]": Q.pJ.squareBracket,
          "{ }": Q.pJ.brace,
      ...
      const v = h.qp.define({
          ...
          parser: _.configure({
            props: [
              h.x0.add({
                ...
                Comment: (O, $) => ({
                  from: O.from + 2,
                  to: "*/" == $.sliceDoc(O.to - 2, O.to) ? O.to - 2 : O.to,
                }),
              }),
              h.uj.add({ Declaration: (0, h.tC)() }),
            ],
          }),
          languageData: {
        ...
        Y = v.configure({
          dialect: "indented",
          props: [
            h.uj.add({ "Block RuleSet": (O) => O.baseIndent + O.unit }),
            h.x0.add({ Block: (O) => ({ from: O.from, to: O.to }) }),
          ],
        }),
        x = (0, j.defineCSSCompletionSource)(
          (O) => "VariableName" == O.name || "SassVariableName" == O.name,
        );
      function W(O) {
        return new h.ri((null == O ? void 0 : O.indented) ? Y : v, v.data.of({ autocomplete: x }));
      }
    },
  },
]);
