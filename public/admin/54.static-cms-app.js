...
(globalThis.webpackChunkStaticCmsApp = globalThis.webpackChunkStaticCmsApp || []).push([
  ...
  {
    11054: (O, T, Q) => {
      (Q.r(T), Q.d(T, { less: () => c, lessCompletionSource: () => n, lessLanguage: () => m }));
      var a = Q(72107),
        e = Q(59958),
        S = Q(64963),
        l = Q(7778);
      ...
      const o = new S.Jq((O, T) => {
          if (40 == O.next) {
            let T = O.peek(-1);
            (t(T) || ((Q = T) >= 48 && Q <= 57) || 95 == T || 45 == T) && O.acceptToken(2, 1);
          }
          var Q;
        }),
        i = new S.Jq((O) => {
          if (r.indexOf(O.peek(-1)) > -1) {
            let { next: T } = O;
            (t(T) || 95 == T || 35 == T || 46 == T || 91 == T || 58 == T || 45 == T) &&
              O.acceptToken(110);
          }
        }),
        $ = new S.Jq((O) => {
          if (r.indexOf(O.peek(-1)) < 0) {
            let { next: T } = O;
            if ((37 == T && (O.advance(), O.acceptToken(1)), t(T))) {
              do {
                O.advance();
              } while (t(O.next));
              O.acceptToken(1);
        ...
        y = (0, l.Gv)({
          "import charset namespace keyframes media supports when": l.pJ.definitionKeyword,
          "from to selector": l.pJ.keyword,
          NamespaceName: l.pJ.namespace,
          KeyframeName: l.pJ.labelName,
          TagName: l.pJ.tagName,
          ClassName: l.pJ.className,
          PseudoClassName: l.pJ.constant(l.pJ.className),
          IdName: l.pJ.labelName,
          "FeatureName PropertyName PropertyVariable": l.pJ.propertyName,
          AttributeName: l.pJ.attributeName,
          NumberLiteral: l.pJ.number,
          KeywordQuery: l.pJ.keyword,
          UnaryQueryOp: l.pJ.operatorKeyword,
          "CallTag ValueName": l.pJ.atom,
          VariableName: l.pJ.variableName,
          "AtKeyword Interpolation": l.pJ.special(l.pJ.variableName),
          Callee: l.pJ.operatorKeyword,
          Unit: l.pJ.unit,
          "UniversalSelector NestingSelector": l.pJ.definitionOperator,
          MatchOp: l.pJ.compareOperator,
          "ChildOp SiblingOp, LogicOp": l.pJ.logicOperator,
          BinOp: l.pJ.arithmeticOperator,
          Important: l.pJ.modifier,
          "Comment LineComment": l.pJ.blockComment,
          ColorLiteral: l.pJ.color,
          "ParenthesizedContent StringLiteral": l.pJ.string,
          Escape: l.pJ.special(l.pJ.string),
          ": ...": l.pJ.punctuation,
          "PseudoOp #": l.pJ.derefOperator,
          "; ,": l.pJ.separator,
          "( )": l.pJ.paren,
          "[ ]": l.pJ.squareBracket,
          "{ }": l.pJ.brace,
        ...
        P = S.WQ.deserialize({
          ...
          tokenizers: [i, $, o, 0, 1, 2, 3, 4],
          topRules: { StyleSheet: [0, 5] },
          specialized: [
            { term: 116, get: (O) => X[O] || -1 },
            { term: 23, get: (O) => p[O] || -1 },
          ],
          tokenPrec: 2180,
        }),
        m = a.qp.define({
          name: "less",
          parser: P.configure({
            props: [a.uj.add({ Declaration: (0, a.tC)() }), a.x0.add({ Block: a.Dv })],
          }),
          languageData: {
        ...
        n = (0, e.defineCSSCompletionSource)(
          (O) => "VariableName" == O.name || "AtKeyword" == O.name,
        );
      function c() {
        return new a.ri(m, m.data.of({ autocomplete: n }));
      }
    },
  },
]);
