...
(globalThis.webpackChunkStaticCmsApp = globalThis.webpackChunkStaticCmsApp || []).push([
  [977],
  {
    11977: (e, t, r) => {
      function a(e) {
        var t = e.client || {},
          r = e.atoms || { false: !0, true: !0, null: !0 },
          a = e.builtin || l(c),
          i = e.keywords || l(s),
          n = e.operatorChars || /^[*+\-%<>!=&|~^/]/,
          o = e.support || {},
          u = e.hooks || {},
          d = e.dateSQL || { date: !0, time: !0, timestamp: !0 },
        ...
        function h(e, s) {
          ...
          if (
            o.hexNumber &&
            (("0" == l && e.match(/^[xX][0-9a-fA-F]+/)) ||
              (("x" == l || "X" == l) && e.match(/^'[0-9a-fA-F]*'/)))
          )
            return "number";
          if (
            o.binaryNumber &&
            ((("b" == l || "B" == l) && e.match(/^'[01]+'/)) || ("0" == l && e.match(/^b[01]*/)))
          )
            return "number";
          if (l.charCodeAt(0) > 47 && l.charCodeAt(0) < 58)
            return (
              e.match(/^[0-9]*(\.[0-9]+)?([eE][-+]?[0-9]+)?/),
              o.decimallessFloat && e.match(/^\.(?!\.)/),
              "number"
            );
          if ("?" == l && (e.eatSpace() || e.eol() || e.eat(";"))) return "macroName";
          if ("'" == l || ('"' == l && o.doubleQuote))
            return ((s.tokenize = b(l)), s.tokenize(e, s));
          if (
            ((o.nCharCast && ("n" == l || "N" == l)) ||
              (o.charsetCast && "_" == l && e.match(/[a-z][a-z0-9]*/i))) &&
            ("'" == e.peek() || '"' == e.peek())
          )
            return "keyword";
          if (
          ...
          if (o.commentSlashSlash && "/" == l && e.eat("/")) return (e.skipToEnd(), "comment");
          if (
            (o.commentHash && "#" == l) ||
            ("-" == l && e.eat("-") && (!o.commentSpaceRequired || e.eat(" ")))
          )
            return (e.skipToEnd(), "comment");
          if ("/" == l && e.eat("*")) return ((s.tokenize = f(1)), s.tokenize(e, s));
          if ("." != l) {
            if (n.test(l)) return (e.eatWhile(n), "operator");
            if (p.test(l)) return "bracket";
            if (g.test(l)) return (e.eatWhile(g), "punctuation");
            if (
              "{" == l &&
            ...
            return d.hasOwnProperty(m) && (e.match(/^( )+'[^']*'/) || e.match(/^( )+"[^"]*"/))
              ? "number"
              : r.hasOwnProperty(m)
                ? "atom"
                : a.hasOwnProperty(m)
          ...
          return o.zerolessFloat && e.match(/^(?:\d+(?:e[+-]?\d+)?)/i)
            ? "number"
            : e.match(/^\.+/)
              ? null
              : o.ODBCdotTable && e.match(/^[\w\d_$#]+/)
                ? "type"
                : void 0;
        }
        function b(e, t) {
        ...
        return {
          ...
          indent: function (e, t, r) {
            var a = e.context;
            if (!a) return null;
            var i = t.charAt(0) == a.type;
            return a.align ? a.col + (i ? 0 : 1) : a.indent + (i ? 0 : r.unit);
          },
          languageData: {
            commentTokens: {
      ...
      function i(e) {
        for (var t; null != (t = e.next());) if ("`" == t && !e.eat("`")) return "string.special";
        return (e.backUp(e.current().length - 1), e.eatWhile(/\w/) ? "string.special" : null);
      }
      function n(e) {
        return (
      ...
      function o(e) {
        return e.eat("N") ? "atom" : e.match(/^[a-zA-Z.#!?]/) ? "string.special" : null;
      }
      (r.r(t),
        r.d(t, {
          cassandra: () => h,
          ...
          hooks: {
            ...
            '"': function (e) {
              for (var t; null != (t = e.next());)
                if ('"' == t && !e.eat('"')) return "string.special";
              return (e.backUp(e.current().length - 1), e.eatWhile(/\w/) ? "string.special" : null);
            },
            "`": i,
          },
